...
var G__30108 = o;
(G__30108[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__30145__delegate = function (args){
...
while (G__30146__i < G__30146__a.length) {G__30146__a[G__30146__i] = arguments[G__30146__i + 0]; ++G__30146__i;}
  args = new cljs.core.IndexedSeq(G__30146__a,0,null);
} 
return G__30145__delegate.call(this,args);};
G__30145.cljs$lang$maxFixedArity = 0;
G__30145.cljs$lang$applyTo = (function (arglist__30147){
var args = cljs.core.seq(arglist__30147);
return G__30145__delegate(args);
});
...
var G__30110 = o;
(G__30110[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__30148__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__30149__i < G__30149__a.length) {G__30149__a[G__30149__i] = arguments[G__30149__i + 0]; ++G__30149__i;}
  args = new cljs.core.IndexedSeq(G__30149__a,0,null);
} 
return G__30148__delegate.call(this,args);};
G__30148.cljs$lang$maxFixedArity = 0;
G__30148.cljs$lang$applyTo = (function (arglist__30150){
var args = cljs.core.seq(arglist__30150);
return G__30148__delegate(args);
});
...
var G__30115 = props;
var G__30115__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__30115,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__30115);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__30115__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__30117){
...
var props = map__30118__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30118__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__30118,map__30118__$1,props,class$){
return (function (c){
...
});})(map__30118,map__30118__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__30120){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30121__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render(((function (node_value,map__30121,map__30121__$1,on_write){
return (function (){
...
});})(node_value,map__30121,map__30121__$1,on_write))
);
} else {
...
var G__30124 = jsprops;
(G__30124["defaultValue"] = value);

(G__30124["onChange"] = ((function (G__30124,v,value,on_change){
return (function (p1__30123_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__30123_SHARP_);
});})(G__30124,v,value,on_change))
);
...
var vec__30126 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30126,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30126,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30126,(2),null);
...
var jsprops = ({"argv": v});
var temp__5724__auto___30161 = reagent.impl.template.key_from_vec(v);
if((temp__5724__auto___30161 == null)){
} else {
var key_30162 = temp__5724__auto___30161;
(jsprops["key"] = key_30162);
}
...
var temp__5724__auto___30163 = reagent.impl.template.key_from_vec(argv);
if((temp__5724__auto___30163 == null)){
} else {
var key_30164 = temp__5724__auto___30163;
reagent.impl.template.oset(jsprops,"key",key_30164);
}
...
var G__30130 = reagent.impl.template.__GT_NativeWrapper();
(G__30130["name"] = c);
...
var G__30131 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__30131) : reagent.impl.template.as_element.call(null,G__30131));
} else {
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq30134){
var G__30135 = cljs.core.first(seq30134);
var seq30134__$1 = cljs.core.next(seq30134);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30135,seq30134__$1);
});
...
break;
default:
var G__30174 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__30174;
continue;
...
var n__4607__auto___30176 = a.length;
var i_30177 = (0);
while(true){
if((i_30177 < n__4607__auto___30176)){
(a[i_30177] = reagent.impl.template.as_element((a[i_30177])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___30179 = a.length;
var i_30180 = (0);
while(true){
if((i_30180 < n__4607__auto___30179)){
var val_30181 = (a[i_30180]);
if(((cljs.core.vector_QMARK_(val_30181)) && ((reagent.impl.template.key_from_vec(val_30181) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_30180] = reagent.impl.template.as_element(val_30181));

var G__30186 = (i_30180 + (1));
i_30180 = G__30186;
continue;
} else {
}
...
var ctx = ({});
var vec__30138 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30138,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30138,(1),null);
...
var G__30141 = (cljs.core.count(argv) - first_child);
switch (G__30141) {
case (0):
...
case (1):
var G__30142 = comp;
var G__30143 = jsprops;
var G__30144 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return module$node_modules$react$index.createElement(G__30142,G__30143,G__30144);

break;
default:
return module$node_modules$react$index.createElement.apply(null,cljs.core.reduce_kv(((function (G__30141){
