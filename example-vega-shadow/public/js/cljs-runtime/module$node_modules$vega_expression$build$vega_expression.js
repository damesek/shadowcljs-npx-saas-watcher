...
function parsePrimaryExpression(){if(match("(")){expect("(");var type=parseExpression();expect(")");return type}if(match("[")){type=[];index$jscomp$0=lookahead.start;for(expect("[");!match("]");)match(",")?(lex(),type.push(null)):(type.push(parseConditionalExpression()),match("]")||expect(","));lex();var JSCompiler_object_inline_value_2655=new ASTNode("ArrayExpression");JSCompiler_object_inline_value_2655.elements=type;return JSCompiler_object_inline_value_2655}if(match("{")){type=[];JSCompiler_object_inline_value_2655=
{};var JSCompiler_object_inline_literal_2656=String;index$jscomp$0=lookahead.start;for(expect("{");!match("}");){index$jscomp$0=lookahead.start;var JSCompiler_object_inline_value_2657=lookahead;if(3===JSCompiler_object_inline_value_2657.type){var JSCompiler_object_inline_literal_2658=parseObjectPropertyKey();expect(":");JSCompiler_object_inline_value_2657=parseConditionalExpression();JSCompiler_object_inline_value_2657=finishProperty("init",JSCompiler_object_inline_literal_2658,JSCompiler_object_inline_value_2657)}else 2===
JSCompiler_object_inline_value_2657.type||7===JSCompiler_object_inline_value_2657.type?(throwUnexpected(JSCompiler_object_inline_value_2657),JSCompiler_object_inline_value_2657=void 0):(JSCompiler_object_inline_literal_2658=parseObjectPropertyKey(),expect(":"),JSCompiler_object_inline_value_2657=parseConditionalExpression(),JSCompiler_object_inline_value_2657=finishProperty("init",JSCompiler_object_inline_literal_2658,JSCompiler_object_inline_value_2657));JSCompiler_object_inline_literal_2658="Identifier"===
JSCompiler_object_inline_value_2657.key.type?JSCompiler_object_inline_value_2657.key.name:JSCompiler_object_inline_literal_2656(JSCompiler_object_inline_value_2657.key.value);JSCompiler_object_inline_literal_2658="$"+JSCompiler_object_inline_literal_2658;Object.prototype.hasOwnProperty.call(JSCompiler_object_inline_value_2655,JSCompiler_object_inline_literal_2658)?throwError({},"Duplicate data property in object literal not allowed in strict mode"):JSCompiler_object_inline_value_2655[JSCompiler_object_inline_literal_2658]=
!0;type.push(JSCompiler_object_inline_value_2657);match("}")||expect(",")}expect("}");JSCompiler_object_inline_value_2655=new ASTNode("ObjectExpression");JSCompiler_object_inline_value_2655.properties=type;return JSCompiler_object_inline_value_2655}type=lookahead.type;index$jscomp$0=lookahead.start;if(3===type||legalKeywords[lookahead.value])JSCompiler_object_inline_value_2655=finishIdentifier(lex().value);else if(8===type||6===type)lookahead.octal&&throwError(lookahead,"Octal literals are not allowed in strict mode."),
JSCompiler_object_inline_value_2655=finishLiteral(lex());else{if(4===type)throw Error("Disabled.");if(1===type)type=lex(),type.value="true"===type.value,JSCompiler_object_inline_value_2655=finishLiteral(type);else if(5===type)type=lex(),type.value=null,JSCompiler_object_inline_value_2655=finishLiteral(type);else if(match("/")||match("/\x3d")){var value;lookahead=null;skipComment();type=index$jscomp$0;JSCompiler_object_inline_value_2655=source[index$jscomp$0];assert("/"===JSCompiler_object_inline_value_2655,
"Regular expression literal must start with a slash");JSCompiler_object_inline_literal_2656=source[index$jscomp$0++];for(JSCompiler_object_inline_literal_2658=JSCompiler_object_inline_value_2657=!1;index$jscomp$0<length;)if(JSCompiler_object_inline_value_2655=source[index$jscomp$0++],JSCompiler_object_inline_literal_2656+=JSCompiler_object_inline_value_2655,"\\"===JSCompiler_object_inline_value_2655)JSCompiler_object_inline_value_2655=source[index$jscomp$0++],isLineTerminator(JSCompiler_object_inline_value_2655.charCodeAt(0))&&
throwError({},"Invalid regular expression: missing /"),JSCompiler_object_inline_literal_2656+=JSCompiler_object_inline_value_2655;else if(isLineTerminator(JSCompiler_object_inline_value_2655.charCodeAt(0)))throwError({},"Invalid regular expression: missing /");else if(JSCompiler_object_inline_value_2657)"]"===JSCompiler_object_inline_value_2655&&(JSCompiler_object_inline_value_2657=!1);else if("/"===JSCompiler_object_inline_value_2655){JSCompiler_object_inline_literal_2658=!0;break}else"["===JSCompiler_object_inline_value_2655&&
(JSCompiler_object_inline_value_2657=!0);JSCompiler_object_inline_literal_2658||throwError({},"Invalid regular expression: missing /");JSCompiler_object_inline_value_2655=JSCompiler_object_inline_literal_2656.substr(1,JSCompiler_object_inline_literal_2656.length-2);for(value=JSCompiler_object_inline_literal_2658="";index$jscomp$0<length;){JSCompiler_object_inline_value_2657=source[index$jscomp$0];if(!isIdentifierPart(JSCompiler_object_inline_value_2657.charCodeAt(0)))break;++index$jscomp$0;"\\"===
JSCompiler_object_inline_value_2657&&index$jscomp$0<length?throwError({},"Unexpected token %0","ILLEGAL"):(value+=JSCompiler_object_inline_value_2657,JSCompiler_object_inline_literal_2658+=JSCompiler_object_inline_value_2657)}0<=value.search(/[^gimuy]/g)&&throwError({},"Invalid regular expression",value);JSCompiler_object_inline_value_2657=value;value=testRegExp(JSCompiler_object_inline_value_2655,JSCompiler_object_inline_value_2657);JSCompiler_object_inline_value_2655=finishLiteral({literal:JSCompiler_object_inline_literal_2656+
JSCompiler_object_inline_literal_2658,value:value,regex:{pattern:JSCompiler_object_inline_value_2655,flags:JSCompiler_object_inline_value_2657},start:type,end:index$jscomp$0});peek()}else throwUnexpected(lex())}return JSCompiler_object_inline_value_2655}function parsePostfixExpression(){var expr;for(expr=parsePrimaryExpression();;)if(match(".")){expect(".");index$jscomp$0=lookahead.start;var args=lex();3===args.type||4===args.type||1===args.type||5===args.type||throwUnexpected(args);args=finishIdentifier(args.value);
...
keywords={"if":1,"in":1,"do":1,"var":1,"for":1,"new":1,"try":1,let:1,"this":1,"else":1,"case":1,"void":1,"with":1,"enum":1,"while":1,"break":1,"catch":1,"throw":1,"const":1,yield:1,"class":1,"super":1,"return":1,"typeof":1,"delete":1,"switch":1,"export":1,"import":1,"public":1,"static":1,"default":1,"finally":1,"extends":1,"package":1,"private":1,"function":1,"continue":1,"debugger":1,"interface":1,"protected":1,"instanceof":1,"implements":1},legalKeywords={"if":1,"this":1},Constants={NaN:"NaN",E:"Math.E",
...
opt||{};var whitelist=opt.whitelist?vegaUtil.toSet(opt.whitelist):{},blacklist=opt.blacklist?vegaUtil.toSet(opt.blacklist):{},constants=opt.constants||Constants,functions=(opt.functions||Functions)(visit),globalvar=opt.globalvar,fieldvar=opt.fieldvar,globals={},fields={},memberDepth=0,outputGlobal=vegaUtil.isFunction(globalvar)?globalvar:function(id){return globalvar+'["'+id+'"]'},Generators={Literal:function(n){return n.raw},Identifier:function(n){n=n.name;if(0<memberDepth)return n;if(vegaUtil.hasOwnProperty(blacklist,
