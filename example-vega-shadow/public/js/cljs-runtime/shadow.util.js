...
var len__4730__auto___27494 = arguments.length;
var i__4731__auto___27495 = (0);
while(true){
if((i__4731__auto___27495 < len__4730__auto___27494)){
args__4736__auto__.push((arguments[i__4731__auto___27495]));

var G__27497 = (i__4731__auto___27495 + (1));
i__4731__auto___27495 = G__27497;
continue;
} else {
}
break;
...
/** @this {Function} */
shadow.util.go_BANG_.cljs$lang$applyTo = (function (seq27426){
var self__4718__auto__ = this;
return self__4718__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq27426));
});
...
var G__27506 = (i__4731__auto___27504 + (1));
i__4731__auto___27504 = G__27506;
continue;
} else {
}
break;
...
/** @this {Function} */
shadow.util.log.cljs$lang$applyTo = (function (seq27447){
var G__27448 = cljs.core.first(seq27447);
var seq27447__$1 = cljs.core.next(seq27447);
var G__27449 = cljs.core.first(seq27447__$1);
var seq27447__$2 = cljs.core.next(seq27447__$1);
var G__27450 = cljs.core.first(seq27447__$2);
var seq27447__$3 = cljs.core.next(seq27447__$2);
var G__27451 = cljs.core.first(seq27447__$3);
var seq27447__$4 = cljs.core.next(seq27447__$3);
var G__27452 = cljs.core.first(seq27447__$4);
var seq27447__$5 = cljs.core.next(seq27447__$4);
var G__27453 = cljs.core.first(seq27447__$5);
var seq27447__$6 = cljs.core.next(seq27447__$5);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27448,G__27449,G__27450,G__27451,G__27452,G__27453,seq27447__$6);
});

shadow.util.log.cljs$lang$maxFixedArity = (6);

shadow.util.remove_from_vector = (function shadow$util$remove_from_vector(coll,key){
return cljs.core.persistent_BANG_(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (v,p__27478){
var vec__27479 = p__27478;
var idx = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27479,(0),null);
var item = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27479,(1),null);
