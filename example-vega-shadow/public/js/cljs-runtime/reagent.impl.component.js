...
if((i < len)){
var k = (ks[i]);
var G__30101 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__30102 = (i + (1));
m = G__30101;
i = G__30102;
continue;
...
var temp__5722__auto__ = (p["argv"]);
if((temp__5722__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__29993 = (p["children"]);
return module$node_modules$react$index.Children.toArray(G__29993);
})());
} else {
var v = temp__5722__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__29997 = c;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__29999 = c;
...
return (function() { 
var G__30104__delegate = function (args){
var G__30007 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__30007) : reagent.impl.component.as_element.call(null,G__30007));
};
var G__30104 = function (var_args){
var args = null;
...
while (G__30105__i < G__30105__a.length) {G__30105__a[G__30105__i] = arguments[G__30105__i + 0]; ++G__30105__i;}
  args = new cljs.core.IndexedSeq(G__30105__a,0,null);
} 
return G__30104__delegate.call(this,args);};
G__30104.cljs$lang$maxFixedArity = 0;
G__30104.cljs$lang$applyTo = (function (arglist__30106){
var args = cljs.core.seq(arglist__30106);
return G__30104__delegate(args);
});
...
var _STAR_current_component_STAR__orig_val__30008 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__30009 = c;
reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__30009;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__30008;
}});
...
var G__30010 = key;
var G__30010__$1 = (((G__30010 instanceof cljs.core.Keyword))?G__30010.fqn:null);
switch (G__30010__$1) {
...
return ((function (G__30010,G__30010__$1){
...
var c = this;
var G__30048_30111 = (c["cljsRatom"]);
if((G__30048_30111 == null)){
} else {
reagent.ratom.dispose_BANG_(G__30048_30111);
}
...
var renders_30113 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_30114 = cljs.core.first(cljs.core.vals(renders_30113));
if((cljs.core.count(renders_30113) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_30113))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_30114)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_30114], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__30072 = name;
switch (G__30072) {
case "":
...
var G__30081 = reagent.impl.component.cljsify(body);
return module$node_modules$create_react_class$index(G__30081);
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__30082 = fiber;
var G__30082__$1 = (((G__30082 == null))?null:(G__30082["type"]));
if((G__30082__$1 == null)){
return null;
} else {
return (G__30082__$1["displayName"]);
}
})();
var parent = (function (){var G__30083 = fiber;
if((G__30083 == null)){
return null;
} else {
return (G__30083["return"]);
}
})();
var path = (function (){var G__30084 = parent;
var G__30084__$1 = (((G__30084 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__30084) : reagent.impl.component.fiber_component_path.call(null,G__30084)));
if((G__30084__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__30084__$1)," > "].join('');
}
})();
...
var temp__5718__auto__ = (function (){var or__4131__auto__ = (function (){var G__30086 = c;
if((G__30086 == null)){
return null;
} else {
return (G__30086["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__30087._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4131__auto__ = (function (){var G__30089 = c;
if((G__30089 == null)){
return null;
} else {
return (G__30089["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var or__4131__auto____$1 = (function (){var G__30091 = c;
if((G__30091 == null)){
return null;
} else {
return G__30091._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4131__auto__ = (function (){var G__30093 = instance;
if((G__30093 == null)){
return null;
} else {
return (G__30093["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var G__30094 = instance;
if((G__30094 == null)){
return null;
} else {
return G__30094._currentElement;
}
}
})();
var name = (function (){var G__30095 = elem;
var G__30095__$1 = (((G__30095 == null))?null:(G__30095["type"]));
if((G__30095__$1 == null)){
return null;
} else {
return (G__30095__$1["displayName"]);
}
})();
var owner = (function (){var or__4131__auto__ = (function (){var G__30097 = elem;
if((G__30097 == null)){
return null;
} else {
return (G__30097["_owner"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__30098._owner;
}
}
})();
var path = (function (){var G__30099 = owner;
var G__30099__$1 = (((G__30099 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__30099) : reagent.impl.component.component_path.call(null,G__30099)));
if((G__30099__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__30099__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__30100 = c;
var G__30100__$1 = (((G__30100 == null))?null:G__30100.constructor);
if((G__30100__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__30100__$1);
}
}
})();
